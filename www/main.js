...
const routes = [
    ...
    {
        path: 'api-list',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_api-list_api-list_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./api-list/api-list.module */ 9895)).then(m => m.ApiListPageModule)
    },
    {
        path: 'perfil/:id',
